    ...
    <div className="min-h-screen flex items-center justify-center bg-sacalii-bg relative overflow-hidden">
      ...
      <div className="bg-white p-8 rounded-lg shadow-xl border-t-4 border-sacalii-gold w-full max-w-md z-10 relative">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-3 rounded border border-gray-300 focus:border-sacalii-teal focus:ring-1 focus:ring-sacalii-teal outline-none transition-colors"
          ...
          {error && (
            <div className="text-red-500 text-sm text-center font-semibold bg-red-50 p-2 rounded border border-red-100">
              {error}
            </div>
          )}
          ...
          <button 
            type="submit"
            className="w-full bg-sacalii-gold hover:bg-opacity-90 text-white font-bold py-3 rounded shadow-md transition-all transform active:scale-95"
          >
            LOGIN
          </button>
        </form>
        ...
        <div className="mt-6 text-center text-xs text-gray-400">
          Authorized personnel only. <br/> System Version 1.0.4
        </div>
      </div>
    </div>
  );
